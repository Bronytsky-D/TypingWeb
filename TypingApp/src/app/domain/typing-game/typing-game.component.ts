...
export class TypingGameComponent {
  ...
  wordsUk = 'Швидкий коричневий лис скаче через ледачого пса який лежить під старим дубом На широкому подвір’ї де сусіди люблять спостерігати за птахами Його хутро блищить на ранковому сонці Зелена трава шепоче про вітер а небо безхмарне Сьогодні буде гарний день Для тренування швидкого набору тексту використовуйте цей набір слів щоб покращити свою точність і швидкість Додавши українські символи комфортно тренуватися вдома чи в офісі Безкоштовний інструмент допомагає вдосконалюватись щодня'.split(' ');
  words: string[] = [];
